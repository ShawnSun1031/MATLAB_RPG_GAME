...
uicontrol('style','text','position',[900 300 110 30],'string','玩家1(紅色)移動方式');
uicontrol('style','text','position',[900 280 80 30],'string','上');
uicontrol('style','text','position',[900 260 80 30],'string','左下右');
uicontrol('style','text','position',[900 220 80 30],'string','攻擊方式');
uicontrol('style','text','position',[900 200 80 30],'string','space');
uicontrol('style','text','position',[1100 300 110 30],'string','玩家2(黃色)移動方式');
uicontrol('style','text','position',[1100 280 80 30],'string','W');
uicontrol('style','text','position',[1100 260 80 30],'string','ASD');
uicontrol('style','text','position',[1100 220 80 30],'string','攻擊方式');
uicontrol('style','text','position',[1100 200 80 30],'string','X');
uicontrol('style','text','position',[1000 70 100 30],'string','任務目標:擊殺對方');
uicontrol('style','text','position',[950 330 80 30],'string','玩家2的HP:');
j=uicontrol('style','text','position',[1020 330 80 30],'string','100');
uicontrol('style','text','position',[950 360 80 30],'string','玩家1的HP:');
k=uicontrol('style','text','position',[1020 360 80 30],'string','100');
 ...
 function skill2(obj,event)
        if ispress.x
            [y, fs]=audioread('fart2.wav'); % 讀取音訊檔
            sound(y, fs); % 播放音訊
